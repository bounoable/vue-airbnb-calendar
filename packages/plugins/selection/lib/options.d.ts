...
export declare type ItemState = 'withinSelection' | 'selectable' | 'unselectable' | 'selected' | 'hovered' | 'highlighted' | 'blocked';
...
export declare type DateFormat = string | undefined;
